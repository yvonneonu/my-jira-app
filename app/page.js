...
function SidebarItem({ text, icon, index, activeIndex, onClick }) {
  ...
  return (
    <div
      className={`flex flex-row justify-between items-center w-[240px] cursor-pointer ${backgroundStyle}`}
...
export default function Home() {
  ...
  return (
    <DragDropContext onDragEnd={onDragEnd}>
      <main className="inter relative overflow-hidden">
        <div className="w-full h-[100vh]">
          ...
          <div className="flex flex-row  p-[20px] ">
            <div className="  h-full border-slate-50  bg-white w-[19.8vw] items- justify-center flex ">
              <div className="flex justify-center p-[20px]">
                ...
                <div className="flex flex-grow flex-col absolute bottom-0 items-start justify-start gap-[15px] w-[19vw] p-[15px] ">
